    ...
    class Program
    {
        static void Main(string[] args)
        {
            ...
            do
            {
                ...
                {
                    case "Помощь":
                        Console.WriteLine("Инфо -Выводит список файлов в каталоге\nCD-Переход в каталог\nУдалить-Удаление файла по имени\nDelM-Удаление файла по маске\nСоздать-Создание файла\nКопировать-Копирование файла");
                        break;
                    case "Инфо":
                    ...
                    case "CD":
                        string filePath = "D:\\Новая папка\\Новая папка\\Новая папка";
                    ...
                    case "Создать":
                        string pyt2;
                        Console.WriteLine("Введите путь создания и имя файла");
